...
var _ LookupOp = (*greaterThan)(nil)

//TODO: remove all the ending returns

// IsSubsetOf implements LookupOp
func (op *greaterThan) IsSubsetOf(otherOp LookupOp) (bool, error) {
...
func (op *greaterThan) IsSupersetOf(otherOp LookupOp) (bool, error) {
	return otherOp.IsSubsetOf(op)
}

// Union implements LookupOp
func (op *greaterThan) Union(otherOp LookupOp) (LookupOp, error) {
	switch other := otherOp.(type) {
	case *all:
	case *none:
	case *equals:
...
func (op *greaterThan) Intersection(otherOp LookupOp) (LookupOp, error) {
	switch other := otherOp.(type) {
	case *all:
	case *none:
	case *equals:
...
func (op *greaterThan) ToReadRange() *noms.ReadRange {
