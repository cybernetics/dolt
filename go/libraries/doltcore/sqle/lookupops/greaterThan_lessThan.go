...
type greaterThan_lessThan struct { // underscore is for clarity
	nbf   *types.NomsBinFormat
	gtKey types.Tuple
	ltKey types.Tuple
}

var _ LookupOp = (*greaterThan_lessThan)(nil)

//TODO: remove all the ending returns

// IsSubsetOf implements LookupOp
func (op *greaterThan_lessThan) IsSubsetOf(otherOp LookupOp) (bool, error) {
...
func (op *greaterThan_lessThan) IsSupersetOf(otherOp LookupOp) (bool, error) {
	return otherOp.IsSubsetOf(op)
}

// Union implements LookupOp
func (op *greaterThan_lessThan) Union(otherOp LookupOp) (LookupOp, error) {
	switch other := otherOp.(type) {
	case *all:
	case *none:
	case *equals:
...
func (op *greaterThan_lessThan) Intersection(otherOp LookupOp) (LookupOp, error) {
	switch other := otherOp.(type) {
	case *all:
	case *none:
	case *equals:
...
func (op *greaterThan_lessThan) ToReadRange() *noms.ReadRange {
