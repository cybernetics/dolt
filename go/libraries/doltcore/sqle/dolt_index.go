...
func (di *doltIndex) AscendGreaterOrEqual(keys ...interface{}) (sql.IndexLookup, error) {
	...
	return &doltIndexLookup{
		...
		lookupOps: []lookupops.LookupOp{
			lookupops.NewLookupOp_GreaterThanOrEqual(di.indexRowData.Format(), tpl),
		},
	}, nil
}
...
func (di *doltIndex) AscendLessThan(keys ...interface{}) (sql.IndexLookup, error) {
	...
	return &doltIndexLookup{
		idx: di,
		lookupOps: []lookupops.LookupOp{
			lookupops.NewLookupOp_LessThan(di.indexRowData.Format(), tpl),
		},
	}, nil
}
...
func (di *doltIndex) AscendRange(greaterOrEqual, lessThanOrEqual []interface{}) (sql.IndexLookup, error) {
	...
	return &doltIndexLookup{
		idx: di,
		lookupOps: []lookupops.LookupOp{
			lookupops.NewLookupOp_GreaterThanOrEqual_LessThanOrEqual(di.indexRowData.Format(), greaterTpl, lessTpl),
		},
	}, nil
}
...
func (di *doltIndex) DescendGreater(keys ...interface{}) (sql.IndexLookup, error) {
	...
	return &doltIndexLookup{
		idx: di,
		lookupOps: []lookupops.LookupOp{
			lookupops.NewLookupOp_GreaterThan(di.indexRowData.Format(), tpl),
		},
	}, nil
}
...
func (di *doltIndex) DescendLessOrEqual(keys ...interface{}) (sql.IndexLookup, error) {
	...
	return &doltIndexLookup{
		idx: di,
		lookupOps: []lookupops.LookupOp{
			lookupops.NewLookupOp_LessThanOrEqual(di.indexRowData.Format(), tpl),
		},
	}, nil
}
...
func (di *doltIndex) Get(keys ...interface{}) (sql.IndexLookup, error) {
	...
	return &doltIndexLookup{
		idx: di,
		lookupOps: []lookupops.LookupOp{
			lookupops.NewLookupOp_Equals(di.indexRowData.Format(), tpl),
		},
	}, nil
}
